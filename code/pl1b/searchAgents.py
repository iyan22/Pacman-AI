...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        "*** YOUR CODE HERE ***"
        # Initialise the visited corners list
    ...
    def getStartState(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        # Return the initialised start state
        return self.startState
    ...
    def isGoalState(self, state):
        ...
        """
        "*** YOUR CODE HERE ***"
        # Check if there is any corner not visited yet
...
def foodHeuristic(state, problem):
    ...
    for f in range(len(foodList)):
        dis.append(mazeDistance(position, foodList[f], problem.startingGameState))
    return max(dis)
